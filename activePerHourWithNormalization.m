function [pActivePerHour, tBinPerHour, tBaseBin] = activePerHourWithNormalization(data, parms)
    ...
    for iHour = 1:nHours
        ...
        pActivePerHour{iHour} = sum(unitActiveBins) / data.nUnits;
